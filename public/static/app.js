...
const translations = {
  al: {
    ...
    hero: {
      ...
      available: 'Kemi dhoma të lira! Rezervoni tani.',
      notAvailable: 'Na vjen keq, nuk kemi dhoma të lira për këto data.',
      selectDates: 'Ju lutem zgjidhni datat'
    },
    rooms: {
      title: 'Akomodimi',
      subtitle: 'Zgjidhni dhomën tuaj të përsosur',
      perPerson: 'për person/natë',
    ...
    reviews: {
      ...
      subtitle: 'Vlerësime nga Google Maps'
    },
    contact: {
      title: 'Kontakti',
      address: 'Adresa',
      addressText: 'Peshkopi, Dibër, Shqipëri',
      phone: 'Telefon',
      email: 'Email',
      followUs: 'Na ndiqni'
    },
  ...
  en: {
    ...
    contact: {
      title: 'Contact',
      address: 'Address',
      addressText: 'Peshkopi, Dibër, Albania',
      phone: 'Phone',
      email: 'Email',
      followUs: 'Follow us'
    },
  ...
  de: {
    ...
    hero: {
      ...
      available: 'Zimmer verfügbar! Jetzt buchen.',
      notAvailable: 'Leider keine Zimmer für diese Daten verfügbar.',
      selectDates: 'Bitte wählen Sie Daten'
    },
    rooms: {
      title: 'Unterkunft',
    ...
    gastro: {
      title: 'Traditionelle Dibran-Küche',
      subtitle: 'Genießen Sie authentische Küche'
    },
    reviews: {
    ...
    contact: {
      title: 'Kontakt',
      address: 'Adresse',
      addressText: 'Peshkopi, Dibër, Albanien',
      phone: 'Telefon',
      email: 'E-Mail',
  ...
  fr: {
    ...
    hero: {
      ...
      available: 'Chambres disponibles! Réservez maintenant.',
      notAvailable: 'Désolé, pas de chambres disponibles pour ces dates.',
    ...
    contact: {
      title: 'Contact',
      address: 'Adresse',
      addressText: 'Peshkopi, Dibër, Albanie',
      phone: 'Téléphone',
      email: 'Email',
...
const amenityNames = {
  al: { wifi: 'WiFi', tv: 'TV', heating: 'Ngrohje', bathroom: 'Banjë', balcony: 'Ballkon', 'mountain-view': 'Pamje malore', minibar: 'Minibar', safe: 'Kasafortë' },
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            <select onchange="changeLang(this.value)" class="bg-emerald-50 border border-emerald-200 text-emerald-800 text-sm rounded-lg px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500 cursor-pointer">
              <option value="al" ${currentLang === 'al' ? 'selected' : ''}>🇦🇱 AL</option>
              ...
              <div class="p-6">
                <div class="flex justify-between items-start mb-3">
                  ...
                  <div class="text-right">
                    <span class="text-2xl font-bold text-emerald-600">€${room.pricePerPerson}</span>
                ...
                <a href="https://wa.me/355684340580?text=${encodeURIComponent(`Përshëndetje! Dua të rezervoj: ${getLocalizedText(room.name)}`)}" 
                   target="_blank"
    ...
    <section id="physio" class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="text-center mt-10">
          <a href="https://wa.me/355684340580?text=${encodeURIComponent('Përshëndetje! Dua informacion për shërbimet e fizioterapisë.')}" 
             target="_blank"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p class="text-emerald-200 text-sm">
              ${getLocalizedText(content.hero?.subtitle) || 'Relaksim dhe shëndet në zemër të Alpeve Shqiptare'}
            </p>
          </div>
